...
<title>회원 가입 - AllDiscounts</title>
...
<link rel="stylesheet" type="text/css" href="./css/member_mobile.css" media="screen and (max-width: 959px)">
<link rel="stylesheet" type="text/css" href="./css/member.css" media="screen and (min-width: 960px)">
<script>
   ...
   function check_email() {
     window.open("member_check_email.php?email=" + document.member_form.email1.value + '@' + document.member_form.email2.value,
         "EMailcheck",
          "left=700,top=300,width=350,height=200,scrollbars=no,resizable=yes");
   }
